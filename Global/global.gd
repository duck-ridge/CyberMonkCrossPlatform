...
func _ready():
	gongde_sum = DataLoader.main_csv.get("gongde_sum", 0)
	...
	building_level_up_index = DataLoader.main_csv.get("building_level_up_index", 0)
...
var building_level_up_index: float = 1
